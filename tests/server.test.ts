...
describe('composeMessageHandlers', () => {
    test('handlers called with message and each successive state', async () => {
        expect.assertions(7)
    ...
    test('cleanups of previous handlers called in reverse order and initial error returned', async () => {
